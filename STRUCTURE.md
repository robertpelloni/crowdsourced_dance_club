...
- `src/`: Central coordination logic.
  - `main.py`: FastAPI Conductor Server. Manages room state, calculates vibe scores, handles WebSockets, and runs the playback simulation loop.
...
- `engine/`: High-performance audio playback.
  - `src/`: Implementation files.
    - `audio_engine.cpp`: Core engine logic, PortAudio callback, SoundTouch integration, and DSP processing (Compressor, HPF).
